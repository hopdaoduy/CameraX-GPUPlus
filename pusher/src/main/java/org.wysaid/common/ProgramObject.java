...
public class ProgramObject {
    public static final String LOG_TAG = org.wysaid.common.Common.LOG_TAG;
    ...
    public boolean init(final String vsh, final String fsh, int programID) {
        ...
        org.wysaid.common.Common.checkGLError("AttachShaders...");
    ...
    public int getUniformLoc(final String name) {
        ...
        if(org.wysaid.common.Common.DEBUG) {
            if(uniform < 0)
