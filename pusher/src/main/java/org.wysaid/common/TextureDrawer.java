...
public class TextureDrawer {
    ...
    protected org.wysaid.common.ProgramObject mProgram;
    protected int mVertBuffer;
    protected int mRotLoc, mFlipScaleLoc;

    public org.wysaid.common.ProgramObject getProgram() {
        return mProgram;
    }
    ...
    protected boolean init(final String vsh, final String fsh) {
        mProgram = new org.wysaid.common.ProgramObject();
    ...
    public static TextureDrawer create() {
        ...
        {
            Log.e(org.wysaid.common.Common.LOG_TAG, "TextureDrawer create failed!");
            drawer.release();
            drawer = null;
        }
        return drawer;
